        ...
        <div class="row">
            <div class="col col-lg-3 mb-3 p-3">
                <div class="p-4 border">
                    ...
                    <a href="${path}/mypageReview.do" class="d-block mt-2 menu_item" style="color:#efef9b; font-weight:bold"> 리뷰 관리</a>
                </div>
            </div>
                ...
                <div class="container">
                    <form action="${path }/AddReviewPro.do" method="post">
                        ...
                        <div class="btn-wrap container">
                            <input type="submit" value="구매 확정" class="btn btn-primary mb-5" style="background-color: #efef9b; float: right; border: none;">
                        </div>
                    </form>
                </div>
            </div>
