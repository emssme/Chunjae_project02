                ...
                <div class="d-flex justify-content-center" style="width:800px;">
                    <div class="row">
                        <div class="checkout__input">
                            ...
                            <input type="button" class="site-btn" value="아이디 중복 확인" style="margin-left: 20px; width:200px; border:none;" onclick="idCheck()">
                        ...
                        <div class="checkout__input" style="width:600px;">
                            ...
                            <button type="button" id="post_btn" onclick="findAddr()" style="margin-left: 20px; border:none;" class="site-btn" >우편번호 검색</button>
