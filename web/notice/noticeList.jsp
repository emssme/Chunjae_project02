...
<head>
    ...
    #tb1 th { background-color: #efef9b; color:#fff; }
        ...
        <div class="container" style="margin-top:20px;">
            <div class="box_wrap">
                <div class="form-wrap">
                    <form action="${path }/KwdNoticeList.do" method="post">
                        <fieldset class="input-group">
                            ...
                            <input type="submit" value="검색" class="btn btn-primary" style="background-color:#efef9b; border:none; color: #333;">
                        </fieldset>
                    </form>
                </div>
                <table class="table" id="tb1">
                    <thead>
                    <tr class="item" >
                        <th class="item1" style="color:#333">연번</th>
                        <th class="item2" style="color:#333">제목</th>
                        <th class="item3" style="color:#333">작성일</th>
                    </tr>
                    </thead>
                    <tbody>
